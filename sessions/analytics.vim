" ~/.vim/sessions/analytics.vim:
" Vim session script.
" Created by session.vim 2.13.1 on 27 junho 2017 at 16:26:22.
...
silent only
cd ~/Documents/Analytics_Edge/Homework3
...
setlocal fen
silent! normal! zE
let s:l = 156 - ((31 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
156
